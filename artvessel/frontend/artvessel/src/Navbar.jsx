    ...
    <div className="navbar">
        ...
        <div className="right">
            ...
            {user && <div className="logged-in">
                ...
                <Link to={"/" + user.username}><div className="navbar-pfp">
                <img src={user.pfp ? user.pfp : default_pfp} className={user.height >= user.width ? "tall" : "long"} alt="profile picture"></img>
                </div>
                </Link>
            </div>}
        </div>
